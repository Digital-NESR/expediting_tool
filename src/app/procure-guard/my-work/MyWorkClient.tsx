  ...
  return (
    <div className="min-h-[100dvh] bg-white font-sans text-slate-900">
      ...
      <header className="sticky top-0 z-30 flex h-14 items-center gap-3 border-b border-gray-100 bg-white/80 px-4 backdrop-blur-md md:h-16 md:px-8">
        ...
        <Link href="/procure-guard/admin" className="ml-auto rounded-md border border-slate-200 bg-white px-3 py-1.5 text-xs font-bold text-slate-700 hover:bg-[#307c4c]/5">
          Change Test Role
        </Link>
      </header>
      ...
      <main className="mx-auto max-w-[1220px] space-y-5 px-4 py-6 sm:px-6">
        <section className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.22em] text-[#307c4c]">Assigned queue</p>
