...
const ADVANCE_EMAIL_TEST_ROLES = ['Country Controller', 'Supply Chain Director', 'Treasury Director', 'Corporate Controller', 'CFO', 'Requester Updates'];
...
function initialRoleTestRecipients(editRequest: AdvancePaymentRequest | undefined, requesterEmail: string) {
    ...
    <div className="min-h-[100dvh] bg-white font-sans text-slate-900">
      ...
      <main className="flex-1 overflow-y-auto pb-20">
        <div className="mx-auto max-w-[1280px] px-5 pt-6 sm:px-8">
          <ProcureGuardHero
            title={isEditMode ? 'Edit Advance Payment Purchase Exception Request' : 'Advance Payment Purchase Exception Request'}
