    ...
    <div>
      ...
      >
        <div style={{ borderLeft: '4px solid #2A7E4F', paddingLeft: 12 }}>
          <h1 style={{ margin: 0, fontSize: 21, fontWeight: 'bold', letterSpacing: 0.2 }}>
            Registry Search
          </h1>
        ...
        <div style={{ display: 'flex', gap: 8, flex: '0 0 auto' }}>
          <button onClick={app.exportCsv} className="btn-outline">
            Export to Excel
          </button>
          <button onClick={app.newDraft} className="btn-primary">
            New Registry Record
          </button>
        </div>
      </div>
      ...
      <div style={{ background: '#fff', border: '1px solid #E4E6E6' }}>
        ...
        >
          ...
          >
            <label
              style={{ fontSize: 10.5, fontWeight: 'bold', color: '#58595B', letterSpacing: 0.6 }}
            >
              SEARCH
            </label>
            <input
              ...
              {[
                ...
                <th
                  ...
                  style={{
                    ...
                    fontSize: 10.5,
                    letterSpacing: 0.6,
                    borderRight: i < 7 ? '1px solid rgba(255,255,255,0.25)' : undefined,
                    textAlign: h === 'ANNUAL SPEND' ? 'right' : 'left',
                  }}
                >
                  {h}
                </th>
            ...
            {rows.map((r, i) => {
              ...
              return (
                <tr
                  ...
                  className="table-row"
                  style={{
                    background: i % 2 ? '#F7FAF8' : '#FFFFFF',
                    cursor: 'pointer',
                    borderBottom: '1px solid #EDEFEF',
                  }}
                >
                  <td
                    style={{
        ...
        {rows.length === 0 && (
          <div
            style={{ padding: '44px 16px', textAlign: 'center', color: '#58595B', fontSize: 13 }}
          >
