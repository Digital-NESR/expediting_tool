  ...
  return (
    <div>
      ...
      <div
        ...
        style={{ background: `linear-gradient(180deg, ${SG_BRAND_SOFT}, #f5f6f5)` }}
      >
        <div className="mx-auto max-w-[1200px] px-6 pb-14 pt-16 text-center lg:px-8">
          ...
          <p className="mx-auto mt-4 max-w-[560px] text-[16px] leading-relaxed text-slate-500">
            Search NESR&apos;s preferred and backup suppliers across the full commodity taxonomy, no
          ...
          <div className="relative mx-auto mt-8 max-w-[620px]">
            <form
              ...
              style={{
                boxShadow: focus
                  ? '0 10px 40px rgba(31,31,29,.14)'
                  : '0 1px 3px rgba(31,31,29,.08)',
              }}
            >
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="truncate text-[12px] text-slate-500">
                        {com.category}
                        {com.subCategory ? ` · ${com.subCategory}` : ''}
                      </div>
                    </div>
          ...
          <div className="mt-4 flex justify-center">
            ...
            >
              <Grid3x3 className="h-4 w-4" style={{ color: SG_BRAND }} /> View full taxonomy{' '}
          ...
          {countries.length > 0 && (
            <div className="mx-auto mt-8 max-w-[940px]">
              <div className="mb-3 text-[12.5px] font-semibold text-slate-500">
                Or jump straight to a country guide
              </div>
                  ...
                  >
                    ...
                    <span className="min-w-0">
                      ...
                      <span className="block text-[11px] text-slate-400">
                        {c.commodities.toLocaleString()} commodities
                      </span>
                    </span>
                  </button>
                ))}
        ...
        {items.map((it) => (
          ...
          >
            ...
            <span className="min-w-0 flex-1">
              ...
              {it.sub && (
                <span className="block truncate text-[11.5px] text-slate-400">{it.sub}</span>
              )}
            </span>
          </button>
        ))}
