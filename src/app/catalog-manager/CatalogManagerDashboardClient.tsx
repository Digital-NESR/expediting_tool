...
import { Icon, Avatar, Chip, EmptyState, StatCard, Card, CardHeader, Meter } from './components/CatalogManagerUI';
  ...
  return (
    ...
    >
      <div className="cm-stagger space-y-6">
        ...
        <section className="relative overflow-hidden rounded-3xl border border-[#cfe4d8] bg-[linear-gradient(180deg,#eaf4ef_0%,#ffffff_72%)] shadow-sm">
          <div
            className="pointer-events-none absolute inset-0 text-[#307c4c] opacity-[0.04]"
          ...
          />
          <div className="pointer-events-none absolute -right-24 -top-32 h-72 w-72 rounded-full bg-[#6aaf8e]/20 blur-3xl" />
          <div className="relative grid gap-8 px-5 py-8 sm:px-7 lg:grid-cols-[minmax(0,1fr)_410px] lg:px-8 lg:py-10">
            <div className="min-w-0">
              ...
              <form onSubmit={submitSearch} className="mt-7 flex max-w-[680px] items-center gap-3 rounded-2xl bg-white/90 px-4 py-3 shadow-lg shadow-[#307c4c]/10 ring-1 ring-slate-200 backdrop-blur-sm transition-shadow duration-300 focus-within:shadow-xl focus-within:shadow-[#307c4c]/15 focus-within:ring-2 focus-within:ring-[#307c4c]/25">
