                ...
                {filtered.length === 0 ? (
                  ...
                  <tr key={r.id} className="hover:bg-[#307c4c]/5">
                    ...
                    <td className="px-5 py-4 align-top text-right">
                      <Link href={`/procure-guard/adhoc-payments/${r.id}`} className="inline-flex min-w-[4.5rem] items-center justify-center whitespace-nowrap rounded-lg bg-[#307c4c] px-3 py-1.5 text-xs font-bold text-white shadow-sm hover:bg-[#25663d]">
                        View
                      </Link>
                    </td>
                  </tr>
