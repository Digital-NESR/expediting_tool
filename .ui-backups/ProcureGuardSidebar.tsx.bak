      ...
      >
        ...
        <nav className="flex-1 overflow-y-auto p-3">
          <Link
            ...
            className="mb-2 flex w-full items-center gap-3 rounded-lg border border-slate-200 bg-white px-3 py-3 text-sm font-semibold text-slate-700 shadow-sm transition-all hover:border-[#307c4c]/30 hover:bg-[#307c4c]/5 hover:text-[#307c4c]"
          >
            <Icon name="home" />
