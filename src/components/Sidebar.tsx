      ...
      {({ pinned, togglePin, closeOnNav }) => {
        const NavLink = ({
          ...
          return (
            ...
            >
              {isActive && (
                <div className="absolute left-0 top-1 bottom-1 w-1 bg-[#307c4c] rounded-r-md" />
              )}
              <span
                className={
                  isActive ? 'text-[#307c4c]' : 'text-slate-400 group-hover:text-slate-600'
                }
              >
                {icon}
              </span>
          ...
          <>
            ...
            <SidebarProfileFooter
              ...
              avatar={{
                ...
                imageClassName:
                  'h-10 w-10 rounded-full object-cover border border-[#307c4c]/20 shadow-sm shrink-0',
                fallbackClassName:
                  'h-10 w-10 flex items-center justify-center rounded-full bg-[#307c4c]/10 border border-[#307c4c]/20 text-[#307c4c] font-bold shadow-sm shrink-0',
              }}
            />
          </>
        );
