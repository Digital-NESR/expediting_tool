...
import {
  ...
  fmtDate, sarFmt, usdFmt, calcDays,
} from '@/lib/tite-utils';
                ...
                <thead>
                  <tr className="border-b border-slate-100 bg-slate-50">
                    {['Shipment', 'Route', 'Movement', 'Deposit', 'Expiry', 'Status'].map(h => (
                      <th key={h} className="text-left text-[11px] font-semibold uppercase tracking-wider text-slate-400 px-4 py-2.5 whitespace-nowrap">{h}</th>
                    ))}
                  </tr>
                </thead>
                <tbody>
