        ...
        {item && (
          <>
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-8">
              ...
              <section>
                <h3 className="text-sm font-semibold uppercase tracking-wider text-slate-400 mb-4 border-b border-slate-100 pb-2">
                ...
                <div className="grid grid-cols-2 gap-y-4 gap-x-6">
                    ...
                    <dd className="text-sm font-semibold text-slate-800 font-mono">
                      {item['SAP MAT ID']?.trim() ? (
                        ...
                        <span className="text-gray-400 italic text-xs">
                          {item['Account Classification Description']?.trim() || 'N/A'}
                        </span>
                      )}
                    </dd>
                  </div>
                  ...
                  <div>
                    ...
                    <dd className="text-sm font-bold text-[#307c4c] tabular-nums">
              ...
              <section>
                ...
                <div className="grid grid-cols-2 gap-y-4 gap-x-6">
                  ...
                  <div>
                    ...
                    <dd className="text-sm font-medium text-slate-700 bg-slate-100 inline-flex px-2 py-0.5 rounded-md border border-slate-200">
                      {item['Country'] || '—'}
                    </dd>
                  </div>
                </div>
                    ...
                    <div className="bg-slate-50 rounded-xl p-4 border border-slate-200/60 shadow-inner min-h-[120px]">
                      {item['Delivery Comments'] ? (
                        ...
                        <p className="text-sm text-slate-400 italic">
                          No comments available for this line item.
                        </p>
                      )}
                    </div>
                  </div>
