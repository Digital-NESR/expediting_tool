...
import { SPEND_TYPE_OPTIONS } from '@/lib/catalog-manager-utils';
...
export default function GridEntryPanel({
  ...
  const blank = (): GridRow => ({ key: keySeq++, supplier: '', code: '', country: baseCountry, category: '', subcategory: '', description: '', uom: '', price: '', currency: baseCcy, effective: todayStr(), expiry: '' });
