    ...
    <div style={{ animation: 'fadeIn 0.2s ease' }}>
      ...
      >
        ...
        >
          ...
          <div style={{ fontSize: 28, fontWeight: 'bold', color: '#2A7E4F' }}>
            {vm.receivedCount}
          </div>
      ...
      >
        ...
        >
          ...
          >
            <div style={{ color: 'white', fontWeight: 'bold', fontSize: 13, letterSpacing: 2 }}>
              NESR
            </div>
          ...
          <div style={{ padding: 18 }}>
            ...
            <div style={{ borderTop: '1px solid #E0E0E0', paddingTop: 12 }}>
              ...
              >
                <div style={{ fontSize: 11, color: '#58595B', marginBottom: 6 }}>
