...
const GROUPS = [
  {
    key: 'overdue',
    label: 'Overdue — escalate now',
    desc: 'Past re-export deadline. Penalty risk.',
  },
  {
    key: 'urgent',
    label: 'Urgent — within 7 days',
    desc: 'Submit extension or initiate re-export immediately.',
  },
  {
    key: 'action',
    label: 'Action required — within 14 days',
    desc: 'Begin extension paperwork or schedule re-export.',
  },
  {
    key: 'plan',
    label: 'Plan ahead — within 30 days',
    desc: 'Confirm re-export plan with operations.',
  },
        ...
        <div className="flex items-end justify-between gap-4 mb-6">
          <div>
            ...
            <p className="text-sm text-slate-500 mt-1">
              Automated rollup based on effective expiry dates.
            </p>
          </div>
        </div>
              ...
              >
                <div className="flex items-center gap-3 px-4 py-3 border-b border-slate-100">
                  <span
                    ...
                    style={{ background: BUCKET_HEX[g.key] }}
                  />
                    ...
                    <tbody>
                      {g.items.map((s) => {
                        ...
                        return (
                          ...
                          >
                            <td className="px-4 py-2.5 font-mono text-[12px] text-slate-500 whitespace-nowrap">
                            ...
                            <td className="px-3 py-2.5">
                              {(() => {
                                ...
                                return (
                                  <span
                                    className={`inline-flex items-center px-2 py-0.5 rounded-full text-[10.5px] font-semibold whitespace-nowrap ${sb.className}`}
                                  >
                                    {sb.label}
                                  </span>
                                );
