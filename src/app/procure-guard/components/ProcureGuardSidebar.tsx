...
const NAV = [
  ...
  { href: '/procure-guard/adhoc-payments/new', label: 'New Adhoc PO', icon: 'plus', access: ['requester', 'viewer', 'reviewer', 'admin'] },
  { href: '/procure-guard/advance-payments', label: 'Advance Requests', icon: 'wallet', access: ['requester', 'viewer', 'reviewer', 'admin'] },
  { href: '/procure-guard/advance-payments/new', label: 'New Advance Request', icon: 'plus', access: ['requester', 'viewer', 'reviewer', 'admin'] },
