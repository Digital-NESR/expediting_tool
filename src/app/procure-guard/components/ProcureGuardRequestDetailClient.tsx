          ...
          <div className="relative flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
            ...
            <div className="flex flex-wrap items-center gap-2">
              {canEditRequest && (
                <Link
                  href={editHref}
                  className="rounded-md border border-white/30 bg-white/10 px-3 py-2 text-xs font-bold text-white backdrop-blur-sm transition hover:bg-white/20"
                >
                  Edit request
                </Link>
              )}
              {hasDecisionActions && (
                <button
                  ...
                  className="rounded-md bg-white px-3 py-2 text-xs font-bold text-[#1d4f31] shadow-sm transition hover:bg-white/90"
                >
                  Go to decision
                </button>
              )}
