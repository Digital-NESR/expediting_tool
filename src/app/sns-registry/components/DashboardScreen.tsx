      ...
      >
        {charts.map((c) => (
          <div key={c.title} style={{ background: '#fff', border: '1px solid #E4E6E6' }}>
            ...
            <div
              style={{ padding: '14px 18px', display: 'flex', flexDirection: 'column', gap: 11 }}
            >
              {c.bars.map((b) => (
                <div key={b.name}>
                  <div
                  ...
                  >
                    ...
                    <span style={{ color: '#58595B', fontVariantNumeric: 'tabular-nums' }}>
                      {b.label}
                    </span>
                  </div>
      ...
      <div style={{ background: '#fff', border: '1px solid #E4E6E6', marginTop: 16 }}>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap' }}>
          {statusDist.map((s) => (
            <div
              key={s.name}
              style={{ flex: '1 1 150px', padding: '14px 18px', borderRight: '1px solid #F0F1F1' }}
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: 7 }}>
                <span style={{ width: 9, height: 9, borderRadius: '50%', background: s.color }} />
                <span style={{ fontSize: 11.5, fontWeight: 'bold', color: '#58595B' }}>
                  {s.name}
                </span>
              </div>
