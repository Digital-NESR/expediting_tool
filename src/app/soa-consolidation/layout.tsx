...
/* This is an admin-only prototype surface. It had no server-side gate at all,
   so any signed-in employee could open it. Same rule and same deny card as
   /admin (ADMIN_EMAILS, via the shared helper). */
          ...
          <div className="w-14 h-14 bg-red-50 rounded-full flex items-center justify-center mx-auto mb-5">
            ...
            >
              <path
                ...
                d="M12 15v2m0-9v4m-6.364 5.364A9 9 0 1118.364 5.636 9 9 0 015.636 18.364z"
              />
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
