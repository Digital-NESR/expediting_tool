          ...
          {status === 'new' && (
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-8 text-center">
              ...
              <p className="text-sm text-slate-500 mt-2 leading-relaxed max-w-xs mx-auto">
                SourceGuide lets you search NESR&apos;s approved suppliers across every country
                guide. Request access and an administrator will review it.
              </p>
              {errorMsg && (
                <p className="text-sm text-red-600 mt-4 bg-red-50 border border-red-100 rounded-lg px-3 py-2">
                  {errorMsg}
                </p>
              )}
