                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <span className="rounded-full bg-gray-100 px-2.5 py-1 text-[11px] font-medium text-gray-400">Coming Soon</span>
                    </div>
                    <div>
                      <h3 className="text-[15px] font-semibold text-slate-500">{course.title}</h3>
                      {course.description && <p className="mt-1.5 text-sm leading-relaxed text-slate-400">{course.description}</p>}
                    </div>
                  </div>
                );
              }
