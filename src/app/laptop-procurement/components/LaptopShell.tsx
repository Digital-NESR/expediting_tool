...
export const CTA =
  'rounded-lg bg-[#307c4c] px-4 py-2.5 text-sm font-bold text-white shadow-sm transition hover:bg-[#307c4c]/80';
export const CTA_QUIET =
  'rounded-lg border border-slate-200 bg-white px-4 py-2.5 text-sm font-bold text-slate-700 shadow-sm transition hover:bg-slate-50';

const NAV = [
  {
    href: '/laptop-procurement',
    label: 'Dashboard',
    icon: 'grid',
    access: ['requester', 'reviewer', 'admin', 'viewer'],
  },
  {
  ...
  {
    href: '/laptop-procurement/requests',
    label: 'Requests',
    icon: 'laptop',
    access: ['requester', 'reviewer', 'admin', 'viewer'],
  },
  {
    href: '/laptop-procurement/requests/new',
    label: 'New Request',
    icon: 'plus',
    access: ['requester', 'reviewer', 'admin'],
  },
  {
    href: '/laptop-procurement/analytics',
    label: 'Analytics',
    icon: 'chart',
    access: ['reviewer', 'admin', 'viewer'],
  },
  {
    href: '/laptop-procurement/delegate',
    label: 'Delegate',
    icon: 'delegate',
    access: ['reviewer', 'admin'],
  },
  {
    href: '/laptop-procurement/help',
    label: 'Help & Training',
    icon: 'help',
    access: ['requester', 'reviewer', 'admin', 'viewer'],
  },
  {
    href: '/admin?tool=laptop-procurement-admin',
    label: 'Admin Panel',
    icon: 'grid',
    access: ['admin'],
  },
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          <header className="sticky top-0 z-30 flex h-14 items-center gap-3 border-b border-gray-100 bg-white/80 px-4 backdrop-blur-md md:h-16 md:px-8">
            ...
            <span className="lg:hidden">
              <LaptopProcurementLogo size="sm" />
            </span>
            <div className="min-w-0">
              <h1 className="truncate text-[17px] font-bold leading-tight tracking-tight text-slate-900 sm:text-lg">
                {title}
              </h1>
