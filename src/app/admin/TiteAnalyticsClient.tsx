  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-top-2 duration-300">
      <div>
        ...
        <p className="text-[12px] text-gray-400 mt-0.5">Audit-ready reports for customs, finance and legal.</p>
      </div>
          ...
          {REPORTS.map((r, i) => (
            <div key={i} className="flex items-center gap-3 px-4 py-3.5 hover:bg-slate-50 transition-colors">
              <div className="w-9 h-9 rounded-lg flex items-center justify-center shrink-0" style={{ background: '#006B0C18' }}>
                <svg className="w-4 h-4" style={{ color: '#006B0C' }} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
