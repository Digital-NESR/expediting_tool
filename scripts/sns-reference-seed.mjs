...
export const TAXONOMY = [
  [
    'Direct',
    'Field Technical Equipment & Services',
    [
      [
        'Downhole Tools',
        [
  ...
  [
    ...
    [
      ...
      ['Legal', [['Legal Counsel', ['Corporate counsel', 'Litigation support']]]],
    ],
  ],
  [
    'Indirect',
  ...
  [
    'Direct',
    'Operation Rental',
    [['Equipment Rental', [['Rental Units', ['Rental frac tanks', 'Rental compressors']]]]],
  ],
  [
    'Indirect',
    'Manpower',
    [['Contract Labor', [['Field Contractors', ['Rig crew supply', 'Technician staffing']]]]],
  ],
  [
    'Direct',
    'Cement',
    [['Cementing Materials', [['Bulk Cement', ['Class G cement', 'Class H cement']]]]],
  ],
  [
    'Direct',
    'Nitrogen',
    [['Nitrogen Supply', [['Bulk Nitrogen', ['Liquid nitrogen', 'Nitrogen membrane units']]]]],
  ],
  ['Direct', 'Natural Sand', [['Proppant', [['Frac Sand', ['Northern white sand']]]]]],
];
