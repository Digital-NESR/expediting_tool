...
export function AccessRequestModal({
  ...
  if (cfg.layout === 'simple') {
    return (
      <ModalShell onClose={onClose} panelClass="relative z-10 w-full max-w-md rounded-2xl border border-slate-200 bg-white p-6 shadow-xl">
  ...
  return (
    <ModalShell onClose={onClose} panelClass="relative bg-white rounded-2xl shadow-xl border border-slate-200 w-full max-w-md z-10 animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className={`flex-1 py-2.5 rounded-xl text-sm font-semibold text-white transition-all duration-200 hover:scale-[1.01] active:scale-[0.99] shadow-sm ${
              submitDisabled ? 'bg-slate-200 text-slate-400 cursor-not-allowed' : cfg.submitEnabledClass
            }`}
...
export function PendingModal({
  ...
  return (
    <ModalShell onClose={onClose} panelClass="relative bg-white rounded-2xl shadow-xl border border-slate-200 w-full max-w-sm z-10 animate-in fade-in zoom-in-95 duration-200 p-6 text-center">
